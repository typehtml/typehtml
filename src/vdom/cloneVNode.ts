import { ThChildren, VNode, VNodeProps, VNodeFlags } from '../types';
import {
  createVNode,
  isVNode,
} from './shapes';
...
export default function cloneVNode<Props>(vNodeToClone: VNode<Props>, props?: VNodeProps, ..._children: ThChildren[]): VNode<Props> {
